...
async function _runWithLock(s, r, o, u) {
  ...
  if (1 != o) g.setLimit(o);
  const _ = r == LOCKMODE_SKIP ? 1 : 0, b = await g.tryAcquire(1, _, s);
  updateStore();
  if (!b) return null;
  try {
    return await u();
...
function create_else_block(s) {
  let r, o, u, g, _, b, w, E = new Date(s[3].mtime).toLocaleString() + "", S, L, O = s[5].length + "", D, k, C, T, I, A, x, R = new Date(s[4].mtime).toLocaleString() + "", P, N, B = s[6].length + "", F, M, V, G, j, q, U, z = ensure_array_like(s[11]), W = [];
  for (let r = 0; r < z.length; r += 1) W[r] = create_each_block_1(get_each_context_1(s, z, r));
  ...
  return {
    ...
    m(E, O) {
      ...
      append(G, j);
      if (!q) {
        U = listen(j, "click", s[12]);
        q = true;
      }
    },
    p(s, o) {
      if (2688 & o) {
        z = ensure_array_like(s[11]);
        let u;
        for (u = 0; u < z.length; u += 1) {
          const g = get_each_context_1(s, z, u);
...
function create_fragment(s) {
  ...
  let _ = select_block_type(s, -1), b = _(s);
  return {
    c() {
      r = element("h2");
      o = text(s[0]);
    ...
    p(s, [r]) {
      ...
      if (_ === (_ = select_block_type(s, r)) && b) b.p(s, r); else {
        b.d(1);
        b = _(s);
        if (b) {
          b.c();
...
function serialize(s) {
  return `{"category":"${s.category}","name":"${s.name}","term":${JSON.stringify(s.term)}\n${s.version ? `,"version":"${s.version}"` : ""},\n"mtime":${s.mtime},\n"files":[\n${s.files.map((s => `{"filename":"${s.filename}"${s.displayName ? `,"displayName":"${s.displayName}"` : ""}${s.version ? `,"version":"${s.version}"` : ""},\n"mtime":${s.mtime},"size":${s.size}\n,"data":[${s.data.map((s => `"${s}"`)).join(",")}]}`)).join(",")}]}`;
}
...
var pluginList = writable([]), pluginIsEnumerating = writable(false), ConfigSync = class extends LiveSyncCommands {
  ...
  async watchVaultRawEventsAsync(s) {
    ...
    const o = normalizePath(this.app.vault.configDir), u = void 0;
    ...
    const g = ~~((r && r.mtime || 0) / 1e3), _ = `${s}-${g}`;
    if (this.recentProcessedInternalFiles.contains(_)) return true;
    this.recentProcessedInternalFiles = [ _, ...this.recentProcessedInternalFiles ].slice(0, 100);
...
function get_each_context3(s, r, o) {
  ...
  b[48] = r[o][0];
  b[49] = r[o][1];
  const w = `${PREFIX_PLUGIN_ALL}/${b[48]}`;
  b[50] = w;
  const E = null != (u = b[4].get(b[50])) ? u : MODE_SELECTIVE;
  b[51] = E;
  const S = `${PREFIX_PLUGIN_MAIN}/${b[48]}`;
  b[52] = S;
  const L = null != (g = b[4].get(b[52])) ? g : MODE_SELECTIVE;
  b[53] = L;
  const O = `${PREFIX_PLUGIN_DATA}/${b[48]}`;
  b[54] = O;
  const D = null != (_ = b[4].get(b[54])) ? _ : MODE_SELECTIVE;
  b[55] = D;
  return b;
}
...
function get_each_context_2(s, r, o) {
  ...
  const _ = `${g[58]}/${g[48]}`;
  g[62] = _;
  const b = null != (u = g[4].get(g[62])) ? u : MODE_SELECTIVE;
  g[63] = b;
  return g;
}
...
function create_else_block3(s) {
  let r, o, u, g, _, b = ensure_array_like(Object.entries(s[9]).filter(s[28])), w = [];
  ...
  return {
    ...
    p(s, u) {
      if (115317 & u[0]) {
        b = ensure_array_like(Object.entries(s[9]).filter(s[28]));
        let o;
...
function create_else_block_4(s) {
  ...
  return {
    ...
    p(s, r) {
      if (48 & r[0] && o !== (o = s[15][s[63]] + "")) set_data(u, o);
    },
    i: noop,
    o: noop,
    d(s) {
...
function create_each_block_2(s) {
  let r, o, u, g = s[16](s[63]) + "", _, b, w, E = s[48] + "", S, L, O, D, k, C, T, I;
  function click_handler_6(...r) {
    return s[29](s[58], s[48], s[62], ...r);
  }
  const A = [ create_if_block_52, create_else_block_4 ], x = [];
  function select_block_type_1(s, r) {
    if (s[63] == MODE_SELECTIVE) return 0;
    return 1;
  }
  O = select_block_type_1(s, [ -1, -1, -1 ]);
  D = x[O] = A[O](s);
  return {
    c() {
      r = element("div");
      ...
      attr(r, "class", k = "labelrow " + (s[2] ? "hideeven" : "") + " svelte-17wm1te");
    },
    m(s, g) {
      insert(s, r, g);
      append(r, o);
      ...
      C = true;
      if (!T) {
        I = listen(u, "click", click_handler_6);
        T = true;
      }
    },
    p(o, u) {
      s = o;
      if ((!C || 48 & u[0]) && g !== (g = s[16](s[63]) + "")) set_data(_, g);
      if ((!C || 32 & u[0]) && E !== (E = s[48] + "")) set_data(S, E);
      let b = O;
      O = select_block_type_1(s, u);
      if (O === b) x[O].p(s, u); else {
        group_outros();
        transition_out(x[b], 1, 1, (() => {
          x[b] = null;
        }));
        check_outros();
        D = x[O];
      ...
      if (!C || 4 & u[0] && k !== (k = "labelrow " + (s[2] ? "hideeven" : "") + " svelte-17wm1te")) attr(r, "class", k);
    },
    i(s) {
      if (C) return;
      transition_in(D);
...
function create_each_block_12(s) {
  let r, o, u = s[59] + "", g, _, b, w = ensure_array_like(s[5][s[58]]), E = [];
  for (let r = 0; r < w.length; r += 1) E[r] = create_each_block_2(get_each_context_2(s, w, r));
  ...
  return {
    ...
    p(s, o) {
      if ((!b || 32 & o[0]) && u !== (u = s[59] + "")) set_data(g, u);
      if (115317 & o[0]) {
        w = ensure_array_like(s[5][s[58]]);
        let u;
        for (u = 0; u < w.length; u += 1) {
          const g = get_each_context_2(s, w, u);
          if (E[u]) {
            E[u].p(g, o);
            transition_in(E[u], 1);
          } else {
            E[u] = create_each_block_2(g);
            E[u].c();
            transition_in(E[u], 1);
            E[u].m(r, null);
          }
        ...
        group_outros();
        for (u = w.length; u < E.length; u += 1) out(u);
        check_outros();
      }
    },
    i(s) {
...
function create_else_block_32(s) {
  ...
  return {
    ...
    p(s, r) {
      if (17 & r[0] && u !== (u = s[15][s[51]] + "")) set_data(g, u);
    },
    i: noop,
    o: noop,
    d(s) {
...
function create_if_block_13(s) {
  let r, o, u, g = s[16](s[53]) + "", _, b, w, E, S, L, O, D, k, C, T, I = s[16](s[55]) + "", A, x, R, P, N, B, F, M, V, G, j;
  function click_handler_8(...r) {
    return s[32](s[48], s[52], ...r);
  }
  const q = [ create_if_block_33, create_else_block_22 ], U = [];
  function select_block_type_3(s, r) {
    if (s[53] == MODE_SELECTIVE) return 0;
    return 1;
  }
  S = select_block_type_3(s, [ -1, -1, -1 ]);
  L = U[S] = q[S](s);
  function click_handler_9(...r) {
    return s[33](s[48], s[54], ...r);
  }
  const z = [ create_if_block_23, create_else_block_13 ], W = [];
  function select_block_type_4(s, r) {
    if (s[55] == MODE_SELECTIVE) return 0;
    return 1;
  }
  N = select_block_type_4(s, [ -1, -1, -1 ]);
  B = W[N] = z[N](s);
  return {
    c() {
      r = element("div");
      ...
      attr(r, "class", O = "filerow " + (s[2] ? "hideeven" : "") + " svelte-17wm1te");
      attr(T, "class", "status svelte-17wm1te");
      attr(R, "class", "name");
      attr(C, "class", "filetitle svelte-17wm1te");
      attr(k, "class", M = "filerow " + (s[2] ? "hideeven" : "") + " svelte-17wm1te");
    },
    m(s, g) {
      insert(s, r, g);
      append(r, o);
      ...
      V = true;
      if (!G) {
        j = [ listen(u, "click", click_handler_8), listen(T, "click", click_handler_9) ];
        G = true;
      }
    },
    p(o, u) {
      s = o;
      if ((!V || 17 & u[0]) && g !== (g = s[16](s[53]) + "")) set_data(_, g);
      let b = S;
      S = select_block_type_3(s, u);
      if (S === b) U[S].p(s, u); else {
        group_outros();
        transition_out(U[b], 1, 1, (() => {
          U[b] = null;
        }));
        check_outros();
        L = U[S];
      ...
      if (!V || 4 & u[0] && O !== (O = "filerow " + (s[2] ? "hideeven" : "") + " svelte-17wm1te")) attr(r, "class", O);
      if ((!V || 17 & u[0]) && I !== (I = s[16](s[55]) + "")) set_data(A, I);
      let w = N;
      N = select_block_type_4(s, u);
      if (N === w) W[N].p(s, u); else {
        group_outros();
        transition_out(W[w], 1, 1, (() => {
          W[w] = null;
        }));
        check_outros();
        B = W[N];
      ...
      if (!V || 4 & u[0] && M !== (M = "filerow " + (s[2] ? "hideeven" : "") + " svelte-17wm1te")) attr(k, "class", M);
    },
    i(s) {
      if (V) return;
      transition_in(L);
...
function create_else_block_22(s) {
  ...
  return {
    ...
    p(s, r) {
      if (17 & r[0] && o !== (o = s[15][s[53]] + "")) set_data(u, o);
    },
    i: noop,
    o: noop,
    d(s) {
...
function create_else_block_13(s) {
  ...
  return {
    ...
    p(s, r) {
      if (17 & r[0] && o !== (o = s[15][s[55]] + "")) set_data(u, o);
    },
    i: noop,
    o: noop,
    d(s) {
...
function create_each_block3(s) {
  let r, o, u, g = s[16](s[51]) + "", _, b, w, E = s[48] + "", S, L, O, D, k, C, T, I, A, x;
  function click_handler_7(...r) {
    return s[31](s[48], s[50], ...r);
  }
  let R = s[51] == MODE_SELECTIVE && create_if_block_43(s);
  const P = [ create_if_block_13, create_else_block_32 ], N = [];
  function select_block_type_2(s, r) {
    if (s[51] == MODE_SELECTIVE) return 0;
    return 1;
  }
  k = select_block_type_2(s, [ -1, -1, -1 ]);
  C = N[k] = P[k](s);
  return {
    c() {
      r = element("div");
      ...
      attr(w, "class", "name");
      attr(o, "class", "title svelte-17wm1te");
      attr(r, "class", O = "labelrow " + (s[2] ? "hideeven" : "") + " svelte-17wm1te");
    },
    m(s, g) {
      insert(s, r, g);
      append(r, o);
      ...
      I = true;
      if (!A) {
        x = listen(u, "click", click_handler_7);
        A = true;
      }
    },
    p(o, u) {
      s = o;
      if ((!I || 17 & u[0]) && g !== (g = s[16](s[51]) + "")) set_data(_, g);
      if ((!I || 1 & u[0]) && E !== (E = s[48] + "")) set_data(S, E);
      ...
      if (!I || 4 & u[0] && O !== (O = "labelrow " + (s[2] ? "hideeven" : "") + " svelte-17wm1te")) attr(r, "class", O);
      let b = k;
      k = select_block_type_2(s, u);
      if (k === b) N[k].p(s, u); else {
        group_outros();
        transition_out(N[b], 1, 1, (() => {
          N[b] = null;
        }));
        check_outros();
        C = N[k];
...
function create_fragment3(s) {
  let r, o, u, g, _, b, w, E, S, L, O, D, k, C, T, I, A, x, R, P, N, B, F, M, V, G, j, q, U, z, W, H, K = s[1] && create_if_block_7(s), Q = s[3] && create_if_block_6(s);
  const J = [ create_if_block3, create_else_block3 ], Y = [];
  function select_block_type(s, r) {
    if (0 == s[0].length) return 0;
    return 1;
  }
  x = select_block_type(s, [ -1, -1, -1 ]);
  R = Y[x] = J[x](s);
  return {
    c() {
      r = element("div");
      ...
      attr(E, "class", "svelte-17wm1te");
      attr(O, "class", "svelte-17wm1te");
      attr(u, "class", "buttons svelte-17wm1te");
      attr(C, "class", "svelte-17wm1te");
      attr(k, "class", "buttons svelte-17wm1te");
      attr(A, "class", "list");
      attr(F, "class", "svelte-17wm1te");
      attr(M, "type", "checkbox");
      attr(B, "class", "svelte-17wm1te");
      attr(N, "class", "buttons svelte-17wm1te");
      attr(q, "class", "svelte-17wm1te");
      attr(U, "type", "checkbox");
      attr(j, "class", "svelte-17wm1te");
      attr(G, "class", "buttons svelte-17wm1te");
    },
    m(R, J) {
      insert(R, r, J);
      append(r, o);
      ...
      z = true;
      if (!W) {
        H = [ listen(g, "click", s[22]), listen(b, "click", s[23]), listen(E, "click", s[24]), listen(O, "click", s[26]), listen(C, "click", s[27]), listen(M, "change", s[34]), listen(U, "change", s[35]) ];
        W = true;
      }
    },
    p(s, o) {
      if (s[1]) if (K) K.p(s, o); else {
        K = create_if_block_7(s);
        K.c();
        K.m(u, L);
      } else if (K) {
        K.d(1);
      ...
      let g = x;
      x = select_block_type(s, o);
      if (x === g) Y[x].p(s, o); else {
        group_outros();
...
function instance3(s, r, o) {
  ...
  let E = [], S = 0, L = false, O = false, D = 0, k = false;
  ...
  function askMode(s, r, o) {
    ...
    g.addSeparator();
    const _ = null !== (u = P.get(o)) && void 0 !== u ? u : MODE_SELECTIVE;
    for (const r of [ MODE_SELECTIVE, MODE_AUTOMATIC, MODE_PAUSED ]) g.addItem((u => {
      u.setTitle(`${getIcon(r)}:${R[r]}`).onClick((u => {
  ...
  function applyAutomaticSync(s, r) {
    ...
    const g = normalizePath(b.app.vault.configDir), _ = (null !== (u = null === (o = b.settings.pluginSyncExtendedSetting[s]) || void 0 === o ? void 0 : o.files) && void 0 !== u ? u : []).map((s => `${g}/${s}`));
    b.addOnHiddenFileSync.syncInternalFilesAndDatabase(r, true, false, _);
  }
  ...
  const T = void 0, I = void 0, A = void 0, x = {
    [MODE_SELECTIVE]: "🔀",
    [MODE_PAUSED]: "⛔",
    [MODE_AUTOMATIC]: "✨"
  }, R = {
  ...
  function setMode(s, r) {
    ...
    P.set(s, r);
    o(4, N = P);
    if (!(s in b.settings.pluginSyncExtendedSetting)) o(17, b.settings.pluginSyncExtendedSetting[s] = {
      key: s,
      mode: r,
      files: []
    }, b);
    o(17, b.settings.pluginSyncExtendedSetting[s].files = u, b);
    o(17, b.settings.pluginSyncExtendedSetting[s].mode = r, b);
    b.saveSettingData();
  }
  function getIcon(s) {
    if (s in x) return x[s];
  }
  let P = new Map, N = new Map;
  for (const {key: s, mode: r} of Object.values(b.settings.pluginSyncExtendedSetting)) P.set(s, r);
  N = P;
  let B = {};
  const click_handler = () => scanAgain(), click_handler_1 = () => replicate2(), click_handler_2 = () => requestUpdate(), click_handler_3 = () => requestReload(), click_handler_4 = () => selectAllNewest(), click_handler_5 = () => applyAll(), func = ([s, r]) => s in B, click_handler_6 = (s, r, o, u) => askMode(u, `${s}/${r}`, o), func_1 = (s, r, o) => o.category == s && o.name == r, click_handler_7 = (s, r, o) => askMode(o, `${PREFIX_PLUGIN_ALL}/${s}`, r), click_handler_8 = (s, r, o) => askMode(o, `${PREFIX_PLUGIN_MAIN}/${s}/MAIN`, r), click_handler_9 = (s, r, o) => askMode(o, `${PREFIX_PLUGIN_DATA}/${s}`, r);
  ...
  s.$$set = s => {
    if ("plugin" in s) o(17, b = s.plugin);
  };
  s.$$.update = () => {
    if (131072 & s.$$.dirty[0]) o(21, g = b.deviceAndVaultName);
    ...
    if (131073 & s.$$.dirty[0]) {
      const s = Object.keys(b.settings.pluginSyncExtendedSetting);
      o(5, B = [ ...E, ...s.map((s => `${s}///`.split("/"))).filter((s => s[0] && s[1])).map((s => ({
        category: s[0],
        name: s[1],
        displayName: s[1]
      }))) ].sort(((s, r) => {
  ...
  o(20, u = false);
  return [ E, k, L, O, N, B, _, requestUpdate, requestReload, C, scanAgain, replicate2, selectAllNewest, applyAll, askMode, R, getIcon, b, S, D, u, g, click_handler, click_handler_1, click_handler_2, click_handler_3, click_handler_4, click_handler_5, func, click_handler_6, func_1, click_handler_7, click_handler_8, click_handler_9, input0_change_handler, input1_change_handler ];
}
...
var askYesNo = (s, r) => new Promise((o => {
  ...
  const w = String.fromCharCode.apply(null, [ ...writeString(`${r}:${o}`) ]), E = void 0, S = void 0, L = void 0, O = void 0, D = {
    url: `${s}/${g}`,
    method: b || (_ ? "PUT" : "GET"),
    headers: {
...
var ObsidianLiveSyncSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(q).setName("Encrypting sensitive configuration items").addDropdown((s => s.addOptions(U).setValue(this.plugin.settings.configPassphraseStore).onChange((async s => {
    ...
    const z = localStorage.getItem("ls-setting-passphrase") || "", W = new import_obsidian.Setting(q).setName("Passphrase of sensitive configuration items").setDesc("This passphrase will not be copied to another device. It will be set to `Default` until you configure it again.").addText((s => {
      s.setPlaceholder("").setValue(z).onChange((async s => {
        this.plugin.usedPassphrase = "";
    ...
    if (!this.plugin.settings.liveSync) {
      ...
      new import_obsidian.Setting(H).setName("Sync on Editor Save").setDesc("When you save file on the editor, sync automatically").setClass("wizardHidden").addToggle((s => s.setValue(this.plugin.settings.syncOnEditorSave).onChange((async s => {
    ...
    new import_obsidian.Setting(H).setName("Folders and files to ignore").setDesc("Regular expression, If you use hidden file sync between desktop and mobile, adding `workspace$` is recommended.").setClass("wizardHidden").addTextArea((s => {
...
var databaseCache = {}, OpenKeyValueDatabase = async s => {
  ...
  async watchVaultRawEventsAsync(s) {
    ...
    const r = normalizePath(this.app.vault.configDir), o = void 0;
    ...
    const u = await this.app.vault.adapter.stat(s);
    if (u && "file" != u.type) return;
    const g = ~~((u && u.mtime || 0) / 1e3), _ = `${s}-${g}`;
    if (this.recentProcessedInternalFiles.contains(_)) return;
    this.recentProcessedInternalFiles = [ _, ...this.recentProcessedInternalFiles ].slice(0, 100);
    const b = addPrefix(s, ICHeader), w = await this.localDatabase.getDBEntryMeta(b), E = void 0;
    if (~~((w && w.mtime || 0) / 1e3) == g) return;
    if (0 == g) await this.deleteInternalFileOnDatabase(s); else await this.storeInternalFileToDatabase({
      path: s,
      ...u
    });
  }
  ...
  async syncInternalFilesAndDatabase(s, r, o = false, u = false) {
    ...
    const _ = this.settings.syncInternalFilesIgnorePatterns.replace(/\n| /g, "").split(",").filter((s => s)).map((s => new RegExp(s, "i"))), b = normalizePath(this.app.vault.configDir);
    let w = o ? o : await this.scanInternalFiles();
    const E = !this.settings.usePluginSync ? [] : Object.values(this.settings.pluginSyncExtendedSetting).filter((s => s.mode == MODE_SELECTIVE || s.mode == MODE_PAUSED)).map((s => s.files)).flat().map((s => `${b}/${s}`.toLowerCase()));
    w = w.filter((s => E.every((r => !s.path.toLowerCase().startsWith(r)))));
    const S = (await this.localDatabase.allDocsRaw({
      startkey: ICHeader,
      endkey: ICHeaderEnd,
      include_docs: true
    })).rows.map((s => s.doc)).filter((s => !s.deleted)), L = void 0, O = [ ...new Set([ ...w.map((s => normalizePath(s.path))), ...S.map((s => stripAllPrefixes(this.getPath(s)))) ]) ].filter((s => !u || u && -1 !== u.indexOf(s))).filter((s => E.every((r => !s.toLowerCase().startsWith(r)))));
    ...
    let I = {};
    I = await this.kvDB.get("diff-caches-internal") || {};
    const A = w.reduce(((s, r) => {
      s[r.path] = r;
      return s;
    }), {}), x = S.reduce(((s, r) => {
    ...
    for (const r of O) {
      k++;
      if (k % 100 == 0) Logger(`Hidden file: ${k}/${D}`, g, "sync_internal");
      if (!r) continue;
      if (_.some((s => r.match(s)))) continue;
      if (await this.plugin.isIgnoredByIgnoreFiles(r)) continue;
      const o = r in A ? A[r] : void 0, u = r in x ? x[r] : void 0, b = r in I ? I[r] : {
        storageMtime: 0,
        docMtime: 0
      };
      await R.wait(5);
    ...
    await R.all();
    await this.kvDB.set("diff-caches-internal", I);
    if (("pull" == s || "pullForce" == s) && 0 != C) if (b in T) {
      let s = T[b];
      try {
        const r = Object.values(this.app.plugins.manifests), o = this.app.plugins.enabledPlugins, u = r.filter((s => o.has(s.id)));
        for (const r of u) if (r.dir in T) {
          s -= T[r.dir];
...
function create_each_block4(s) {
  ...
  let j = select_block_type_1(s, -1), q = j(s), U = s[1] && create_if_block_14(s);
  return {
    c() {
      r = element("tr");
      o = element("td");
...
function create_fragment4(s) {
  let r, o, u, g, _, b, w, E, S, L, O, D, k, C, T, I, A, x, R, P, N, B, F, M, V, G, j, q, U, z, W, H, K, Q, J, Y, X, Z, ee, te, ne, ie, se, re, ae, oe, le, ce = s[6] && create_if_block_53(s), ue = s[1] && create_if_block_44(s);
  function select_block_type(s, r) {
    if (s[6]) return create_if_block_34;
  ...
  return {
    ...
    m(de, he) {
      ...
      fe.m(ne, null);
      append(U, ie);
      for (let s = 0; s < pe.length; s += 1) if (pe[s]) pe[s].m(U, null);
      append(U, se);
      append(U, re);
      append(re, ae);
      me.m(ae, null);
...
var ObsidianLiveSyncPlugin = class extends import_obsidian.Plugin {
  ...
  async connectRemoteCouchDB(s, r, o, u, g, _, b) {
    ...
    const E = void 0, S = new index_es_default(s, {
      ...
      fetch: async (r, u) => {
        var g, _;
        let b = "";
        const E = r.toString().substring(s.length), S = null != (g = null == u ? void 0 : u.method) ? g : "GET";
  ...
  async onload() {
    ...
    this.addCommand({
      ...
      editorCallback: (s, r) => {
        const o = r.file;
        if (!o) return;
        this.localDatabase.getDBEntry(getPathFromTFile(o), {}, true, false);
      }
    });
    this.addCommand({
      ...
      editorCallback: async (s, r) => {
        const o = r.file;
        if (!o) return;
        await this.showIfConflicted(getPathFromTFile(o));
      }
    });
    this.addCommand({
      id: "livesync-toggle",
  ...
  async getConflictedStatus(s) {
    ...
    const w = _.data == b.data && _.deleted == b.deleted, E = !isPlainText(s), S = this.settings.resolveConflictsByNewerFile;
    if (w || E || S) {
      const r = void 0, o = void 0;
      let u = _;
      ...
      await this.pullFile(s, null, true);
      Logger(`Automatically merged (${w ? "same," : ""}${E ? "binary," : ""}${S ? "alwaysNewer" : ""}) :${s}`, LOG_LEVEL_NOTICE);
      return true;
    }
    const L = new import_diff_match_patch.diff_match_patch, O = L.diff_main(_.data, b.data);
  ...
  askInPopup(s, r, o) {
    ...
    scheduleTask(g, 1e3, (async () => {
      var s;
      const r = await memoIfNotExist(g, (() => new import_obsidian.Notice(u, 0))), o = void 0;
